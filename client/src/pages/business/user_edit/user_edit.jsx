        ...
        <View className='p-contain'>
          <View className='p-operation-list'>
            <View className='u-item' onClick={this.onClickToUserEdit}>
              <Input className='flex-1' value={this.state.name} placeholder='请输入' />
            </View>
          </View>
          <View className='p-bottom-btn'>
            <Button className='btn-style btn-purple btn-large btn-circle-44' hoverClass='btn-hover' onClick={this.onClickSure}>确认</Button>
          </View>
        </View>
      </View>
    )
